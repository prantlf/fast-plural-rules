...
Find your locale below and learn, how many plural forms will be needed in localized messages with cardinals and what conditions make the plural rule deciding the right plural form.
...
|-------+---------------+------------------------------------------------|
|       |               | nplurals=6; plural=(n==0 ? 0 : n==1 ? 1 : n==2 |
| ar    | Arabic [1]    | ? 2 : n%100>=3 && n%100<=10 ? 3 : n%100>=11 ?  |
|       |               | 4 : 5);                                        |
|-------+---------------+------------------------------------------------|
...
| be    | Belarusian    | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2);                                      |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
|       |               | nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : |
| bs    | Bosnian       | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2);                                      |
|-------+---------------+------------------------------------------------|
| C     |               |                                                |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| cs    | Czech         | nplurals=3; plural=(n==1) ? 0 : (n>=2 && n<=4) |
|       |               | ? 1 : 2;                                       |
|-------+---------------+------------------------------------------------|
| csb   | Kashubian     | nplurals=3; plural=(n==1) ? 0 : n%10>=2 &&     |
|       |               | n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2;    |
|-------+---------------+------------------------------------------------|
| cy    | Welsh         | nplurals=4; plural=(n==1) ? 0 : (n==2) ? 1 :   |
|       |               | (n != 8 && n != 11) ? 2 : 3;                   |
|-------+---------------+------------------------------------------------|
| D     |               |                                                |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| es_AR | Argentinean   | nplurals=2; plural=(n != 1);                   |
|       | Spanish       |                                                |
|-------+---------------+------------------------------------------------|
...
| G     |               |                                                |
|-------+---------------+------------------------------------------------|
| ga    | Irish         | nplurals=5; plural=n==1 ? 0 : n==2 ? 1 : (n>2  |
|       |               | && n<7) ? 2 :(n>6 && n<11) ? 3 : 4;            |
|-------+---------------+------------------------------------------------|
| gd    | Scottish      | nplurals=4; plural=(n==1 || n==11) ? 0 : (n==2 |
|       | Gaelic        | || n==12) ? 1 : (n > 2 && n < 20) ? 2 : 3;     |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
|       |               | nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : |
| hr    | Croatian      | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2);                                      |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| kw    | Cornish       | nplurals=4; plural=(n==1) ? 0 : (n==2) ? 1 :   |
|       |               | (n == 3) ? 2 : 3;                              |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| lv    | Latvian       | nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : |
|       |               | n != 0 ? 1 : 2);                               |
|-------+---------------+------------------------------------------------|
| M     |               |                                                |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
|       |               | nplurals=3; plural=n%10==1 && n%100!=11 ? 0 :  |
| me    | Montenegro    | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2;                                       |
|-------+---------------+------------------------------------------------|
| mfe   | Mauritian     | nplurals=2; plural=(n > 1);                    |
|       | Creole        |                                                |
|-------+---------------+------------------------------------------------|
...
|       |               | Can’t be correct needs a 2 somewhere           |
|-------+---------------+------------------------------------------------|
...
| mt    | Maltese       | n%100>1 && n%100<11) ? 1 : (n%100>10 &&        |
|       |               | n%100<20 ) ? 2 : 3);                           |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| nb    | Norwegian     | nplurals=2; plural=(n != 1);                   |
|       | Bokmal        |                                                |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| nn    | Norwegian     | nplurals=2; plural=(n != 1);                   |
|       | Nynorsk       |                                                |
|-------+---------------+------------------------------------------------|
| no    | Norwegian     | nplurals=2; plural=(n != 1);                   |
|       | (old code)    |                                                |
|-------+---------------+------------------------------------------------|
| nso   | Northern      | nplurals=2; plural=(n != 1);                   |
|       | Sotho         |                                                |
|-------+---------------+------------------------------------------------|
| O     |               |                                                |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| pl    | Polish        | nplurals=3; plural=(n==1 ? 0 : n%10>=2 &&      |
|       |               | n%10<=4 && (n%100<10 || n%100>=20) ? 1 : 2);   |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| ro    | Romanian      | nplurals=3; plural=(n==1 ? 0 : (n==0 || (n%100 |
|       |               | > 0 && n%100 < 20)) ? 1 : 2);                  |
|-------+---------------+------------------------------------------------|
|       |               | nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : |
| ru    | Russian       | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2);                                      |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
| sk    | Slovak        | nplurals=3; plural=(n==1) ? 0 : (n>=2 && n<=4) |
|       |               | ? 1 : 2;                                       |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
|       |               | nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : |
| sr    | Serbian       | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2);                                      |
|-------+---------------+------------------------------------------------|
...
|-------+---------------+------------------------------------------------|
|       |               | nplurals=3; plural=(n%10==1 && n%100!=11 ? 0 : |
| uk    | Ukrainian     | n%10>=2 && n%10<=4 && (n%100<10 || n%100>=20)  |
|       |               | ? 1 : 2);                                      |
|-------+---------------+------------------------------------------------|
...
See also the [original list of plural rule conditions](http://docs.translatehouse.org/projects/localization-guide/en/latest/l10n/pluralforms.html#pluralforms-list) identifying the right plural form.
